  ...
  function Ryans(props) {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this2), "setActive", function (id, method) {
      ...
      if ((_this2.state.active === id || id === null) && method === "clicked") _this2.setState({
        active: null,
        open: false
      });else if (method === "clicked" || method === "gallery-hover") {
        _this2.setState({
          active: id,
          currentDesc: id,
          open: true
...
//# sourceMappingURL=index.js.2d51adc75e07987fdab2.hot-update.js.map